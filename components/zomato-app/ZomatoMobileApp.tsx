    ...
    <div className="bg-[#FFFBF7] grid grid-cols-3 py-10 md:py-20">
        ...
        <div className="right-div grid col-span-3 md:col-span-2 grid-cols-3 gap-1">
            ...
            <div className="radiobox flex gap-1 justify-center items-center">
              ...
              {/* <p className="col-span-3 text-sm mt-1">Downlaod app from</p>            
              <div className="col-span-3 grid grid-cols-3 overflow-hidden">
              <Link href="https://play.google.com/store/apps/details?id=com.application.zomato&hl=en_IN&pli=1" className="col-span-1"><Image src={playStoreBadgeImg} alt='play-store-badge' width={0} height={0} className='w-full h-auto' /></Link>
              <Link href="https://apps.apple.com/in/app/zomato-food-delivery-dining/id434613896" className="col-span-1"><Image src={appStoreBadgeImg} alt='play-store-badge' width={0} height={0} className='w-full h-auto' /></Link>
                </div>         */}
        </div>
    </div>
  )
